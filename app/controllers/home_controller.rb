class HomeController < ApplicationController
  ...
  def send_email
    ...
    amount.to_i.times{ MemberMailer.send_email(from, to, subject, content).deliver }
    #Resque.enqueue(EmailSender, from_name, from_email, subject, to_email, amount, content)
